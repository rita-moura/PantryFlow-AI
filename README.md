...
> Current status: **Roadmap Phase 7 — Cardápio Vivo in progress.** Product and AI
...
8. Cardápio Vivo — in progress: consumption progress and future-only replanning
9. Functional frontend
10. Embeddings, RAG, assistant, tools, and bounded agents
11. Observability, evaluation, Green AI, demo, deployment, and portfolio documentation
